...
public class CsdnPublisher extends AbstractPlatformPublisher {
    ...
    public CsdnPublisher(MarkdownProcessor markdownProcessor) {
    ...
    protected PublishResult doPublish(PublishContext context) {
        ...
        try {
            String articleId = "csdn-" + context.getArticle().getId();
            ...
            return PublishResult.failure(PlatformType.CSDN, e.getMessage());
        }
    }
